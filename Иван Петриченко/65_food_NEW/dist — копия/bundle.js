...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(img, alt, title, descr, price, parentSelector) {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_14__.getResource)("http://localhost:3000/menu").then(function (data) {
    data.forEach(function (_ref) {
      var img = _ref.img,
        ...
        descr = _ref.descr,
        price = _ref.price;
      return new MenuCard(img, alt, title, descr, price, ".menu .container", "menu__item").render();
    });
  });
...
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modal */ "./js/modules/modal.js");
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../services/services */ "./js/services/services.js");
...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener("submit", function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_14__.postData)("http://localhost:3000/requests", json).then(function (data) {
        console.log(data);
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_13__.openModal)(".modal", modalTimerId);
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_13__.closeModal)(".modal");
    }, 4000);
  }
}
...
/* harmony export */ });
/* harmony import */ var _services_throttle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/throttle */ "./js/services/throttle.js");
...
function modal(modalSelector, modalTimerId) {
  ...
  window.addEventListener("scroll", (0,_services_throttle__WEBPACK_IMPORTED_MODULE_0__.throttle)(showModalbySroll, 500));
}
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("\u041E\u0448\u0438\u0431\u043A\u0430 \u0437\u0430\u043F\u0440\u043E\u0441\u0430 \u043F\u043E ".concat(url, " - ").concat(res.status, " ").concat(res.message));
        case 5:
          _context2.next = 7;
          return res.json();
        case 7:
...
document.addEventListener("DOMContentLoaded", function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_7__.openModal)(".modal", modalTimerId);
  }, 12350000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])(".timer", "2024-12-31");
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_7__["default"])(".modal", modalTimerId);
});
})();
